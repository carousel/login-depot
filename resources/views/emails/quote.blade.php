                    ...
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
                        <tbody><tr>
                            <td  class="main-header" style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                ...
                                Dear {!!"customer name"!!},
<img src="http://nationwideautotransportation.com/wp-content/uploads/2014/07/logomobile.png" style="border: 1px solid #e9e9e9;width: 217px;float: right;" alt="">
...
<a href="http://www.logindepot.com/nation/terms_conditions.php?orderid=NT51228&amp;verify=1432834998" style="background-color:cadetblue;padding:7px 7px 7px 7px;font-size:15px;text-decoration:none;color:white;font-weight:bolder;border-radius:4px;float:right;margin-top:16px;margin-right:170px" target="_blank">Click Here To Start Your Booking</a>
</td>
</tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0" width="360">
                                    <tbody>
                                    <tr>
<p class="lead" style="color:#646464;font-weight:bold;margin:0;padding:0;line-height:26px;font-size:18px;font-family:Helvetica,Arial,sans-serif">About Nationwide Auto Transportation</p>
<br>
