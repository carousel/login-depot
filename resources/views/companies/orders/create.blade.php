...
<br>
                {!!Form::open(["url" => "/companies/" . $company_name . "/orders/create","class" => "quote-form"])!!}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!!Form::text("pickup zipcode","90004",["class" => "form-control","placeholder" => "Enter Zip Code"])!!}
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        {!!Form::text("delivery zipcode","701007",["class" => "form-control typeahead","placeholder" => "Enter Zip Code"])!!}
<br>
                    </div>
...
<span></span>
                        {!!Form::select("type_1",$vehicle_type,"Car",["class" => "form-control add-vehicle","placeholder" => "Select vehicle type"])!!}
<span></span>
                        {!!Form::select("condition_1",[null => "Select Condition","Running"=> "Running","Not Running" => "Not Running"],"Running",["class" => "form-control","placeholder" => "Select Vehicle Condition"])!!}
<span></span>
                        {!!Form::label("quantity")!!}
...
<div class="form-inline">
                        {!!Form::select("carrier type",[null => "Select Carrier Type","Open Carrier" => "Open Carrier","Enclosed Carrier" => "Enclosed Carrier"],"Open Carrier",["class" => "form-control","placeholder" => "Select Carrier Type"])!!}
&nbsp;
                    </div>
...
<br>
                    <div class="form-inline">
                        ...
                        {!!Form::label("price")!!}
                        {!!Form::text("price","$600",["class" => "form-control","placeholder" => "Enter Price"])!!}
