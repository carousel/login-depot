...
<br>
            <section class="panel col-md-5 col-md-offset-3 profile-forms">
                ...
                {!!Form::open(["url"=>"/companies/" . $company_name . "/customers/". $customer_object->first_name ."/update","method"=>"post","class" => "basic-profile"])!!}
...
<br>
                ...
                {!!Form::open(["url"=>"/companies/" . $company_name . "/customers/". $customer_object->first_name ."/delete","method"=>"post","class" => "basic-profile"])!!}
